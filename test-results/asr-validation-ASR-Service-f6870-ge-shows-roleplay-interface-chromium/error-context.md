...
- Name: asr-validation.spec.ts >> ASR Service Validation >> homepage shows roleplay interface
- Location: e2e\asr-validation.spec.ts:48:7
...
Locator: locator('text=SGC Tech AI Roleplay Arena')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=SGC Tech AI Roleplay Arena')

```

```yaml
- img "SGC TECH"
- text: SGC TECH Roleplay Arena Enter your access password to continue
- textbox "Enter password"
- button
- button "Access Arena"
- paragraph: Secured access — authorized personnel only
