...
- Name: asr-validation.spec.ts >> ASR Service Validation >> admin dashboard is accessible
- Location: e2e\asr-validation.spec.ts:61:7
...
```yaml
- heading "SGC Admin" [level=1]
- paragraph: Enter admin password to continue
