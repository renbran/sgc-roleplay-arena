...
- Name: auth-and-name.spec.ts >> Cache removal — auth v2 key enforcement >> name appears in header after login
- Location: e2e\auth-and-name.spec.ts:78:7
...
Call log:
  - waiting for locator('[placeholder="Enter password"]')
